...
$pageTitle = 'Blog & News - Cat Rescue Stories';
$metaDescription = 'Read the latest news, cat rescue success stories, care tips, and updates from Careful Cat Rescue in Murfreesboro, TN.';
$metaKeywords = 'cat rescue blog, cat news, serval rescue stories, savannah cat care tips, cat rescue updates Tennessee';
...
<section class="hero" style="padding: 60px 0;">
    <div class="container">
        <h1>Blog &amp; News</h1>
        <p>Stay updated with the latest cat rescue news, success stories, care tips, and updates from our sanctuary.</p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-content text-center" style="padding: 3rem;">
                <h3>No posts yet</h3>
                <p>We're working on some great content! Check back soon for updates and stories from our cat rescue.</p>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<section class="section" style="background: linear-gradient(135deg, var(--primary-color), #c0392b); color: white; text-align: center;">
    <div class="container">
        ...
        <p style="margin-bottom: 1.5rem; opacity: 0.95; font-size: 1.1rem;">Behind every rescue story is a generous donor who made it possible. Help us write more happy endings for cats in need.</p>
    ...
    <div class="container">
        <div class="card" style="max-width: 600px; margin: 0 auto;">
            <div class="card-content text-center">
                ...
                <p class="mb-3">Get the latest cat rescue updates, success stories, and adoption news delivered to your inbox.</p>
