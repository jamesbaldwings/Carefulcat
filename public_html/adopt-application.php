...
$pageTitle = $cat ? 'Adopt ' . $cat['name'] : 'Adoption Application';
$metaDescription = 'Submit a comprehensive adoption application for your new feline companion.';
...
<section class="section">
    <div class="container" style="max-width: 900px;">
        <a href="<?php echo $cat ? '/cat-detail.php?id=' . e($cat['id']) : '/adoptions.php'; ?>" style="display: inline-block; margin-bottom: 1rem; color: var(--text-light);">
            ← Back to <?php echo $cat ? e($cat['name']) : 'Adoptable Cats'; ?>
        </a>
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <h1 class="admin-card-title">🐱 Comprehensive Adoption Application</h1>
                ...
                <form method="POST" action="" class="admin-form" id="adoptionForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-help">We strongly recommend keeping cats indoors for their safety</small>
                        </div>
