            ...
            <div class="card" style="background-color: #f0f9ff; border: 2px solid var(--primary-color);">
                <div class="card-content">
                    <div style="display: grid; grid-template-columns: 120px 1fr; gap: 1.5rem; align-items: center;">
                        <?php if ($adoption['cat_photo'] ?? null): ?>
                        ...
                        <div>
                            ...
                            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                ...
                                <?php if ($adoption['adoption_fee'] ?? null): ?>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['is_18_or_older'] ?? null) ? '✅ Yes' : '❌ No'; ?>
                    </span>
                </div>
                <div class="info-item">
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['landlord_verified'] ?? null) ? '✅ Yes' : '❌ No'; ?>
                    </span>
                </div>
                <?php endif; ?>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['has_allergies'] ?? null) ? '⚠️ Yes' : '✅ No'; ?>
                    </span>
                </div>
                <div class="info-item">
                ...
                <?php if ($adoption['children_ages'] ?? null): ?>
                <div class="info-item">
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                <div class="info-item full-width">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['has_current_pets'] ?? null) ? 'Yes' : 'No'; ?>
                    </span>
                </div>
                <?php if (($adoption['has_current_pets'] ?? null) && $adoption['current_pets_details']): ?>
                <div class="info-item full-width">
                ...
                <?php endif; ?>
                <?php if ($adoption['past_pets_details'] ?? null): ?>
                <div class="info-item full-width">
                ...
                <div class="info-item full-width">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['surrendered_pet_before'] ?? null) ? '⚠️ Yes' : '✅ No'; ?>
                    </span>
                </div>
                <?php if (($adoption['surrendered_pet_before'] ?? null) && $adoption['surrender_reason']): ?>
                <div class="info-item full-width">
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['prepared_for_costs'] ?? null) ? '✅ Yes' : '❌ No'; ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['needs_vet_help'] ?? null) ? 'Yes' : 'No'; ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo ($adoption['open_to_bonded_pair'] ?? null) ? '✅ Yes' : 'No'; ?>
                    </span>
                </div>
                <div class="info-item">
                    <span class="info-label">Open to Special Needs:</span>
                    <span class="info-value">
                        <?php echo ($adoption['open_to_special_needs'] ?? null) ? '✅ Yes' : 'No'; ?>
                    </span>
                </div>
                <div class="info-item">
                    <span class="info-label">Adopted Before:</span>
                    <span class="info-value">
                        <?php echo ($adoption['adopted_before'] ?? null) ? 'Yes' : 'No'; ?>
                    </span>
                </div>
            </div>
            ...
            <div class="card" style="background-color: #fef3c7; border: 1px solid #f59e0b; padding: 1.5rem; margin-top: 1.5rem;">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <?php echo ($adoption['agree_info_true'] ?? null) ? '✅ Agreed' : '❌ Not Agreed'; ?>
                        </span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Provide Vet Care:</span>
                        <span class="info-value">
                            <?php echo ($adoption['agree_vet_care'] ?? null) ? '✅ Agreed' : '❌ Not Agreed'; ?>
                        </span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">No Declawing:</span>
                        <span class="info-value">
                            <?php echo ($adoption['agree_no_declaw'] ?? null) ? '✅ Agreed' : '❌ Not Agreed'; ?>
                        </span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Return if Unable:</span>
                        <span class="info-value">
                            <?php echo ($adoption['agree_return_if_unable'] ?? null) ? '✅ Agreed' : '❌ Not Agreed'; ?>
                        </span>
                    </div>
                    <div class="info-item">
