...
<div class="admin-card">
  <div class="admin-card-header"><h2 class="admin-card-title">👥 User Management</h2></div>
        ...
        <tbody>
          <?php foreach ($users as $u): ?>
            <tr>
              ...
              <td><?php echo $u['last_login'] ? formatDateTime($u['last_login']) : '—'; ?></td>
              <td><?php echo $u['created_at'] ? formatDateTime($u['created_at']) : '—'; ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
