          ...
          <?php foreach($rows as $v): ?>
            <tr>
              ...
              <td style="white-space: nowrap;">
                <a class="btn btn-small" href="/admin/volunteers/view.php?id=<?php echo (int)$v['id']; ?>">View</a>
                ...
                <?php endif; ?>
                <a class="btn btn-small btn-outline" href="/admin/volunteers/edit.php?id=<?php echo (int)$v['id']; ?>">Edit</a>
