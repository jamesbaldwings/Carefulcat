        ...
        <table class="admin-table">
            <tbody>
                <tr>
                    ...
                    <td><?php echo (int)$volunteer['id']; ?></td>
                </tr>
                <tr>
                    <th>Name</th>
                ...
                <tr>
                    ...
                    <td><?php echo $volunteer['background_check'] ? '✅ Completed' : '❌ Not Completed'; ?></td>
                </tr>
                <?php endif; ?>
                <?php if (isset($volunteer['orientation_completed'])): ?>
                <tr>
                    <th>Orientation</th>
                    <td><?php echo $volunteer['orientation_completed'] ? '✅ Completed' : '❌ Not Completed'; ?></td>
                </tr>
                <?php endif; ?>
                <tr>
                    <th>Applied On</th>
