...
$metaDescription = 'Find answers to common questions about adopting, volunteering, and supporting Careful Cat Rescue.';
...
<section class="hero" style="padding: 60px 0;">
    <div class="container">
        ...
        <p>Find answers to common questions about our rescue, adoption process, and how you can help.</p>
    </div>
</section>
        ...
        <div style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="card mb-3">
                <div class="card-content">
                    ...
                    <p>Start by browsing our <a href="/adoptions.php">available cats</a>. When you find one you're interested in, fill out an adoption application. We'll review your application, conduct a home visit if needed, and help you meet the cat. If it's a good match, we'll complete the adoption paperwork and you can take your new friend home!</p>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-content">
                    ...
                    <p>You can make a monetary donation through our <a href="/donate.php">donation page</a>. We also accept supplies, food, and other items. Contact us for our current wish list.</p>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-content">
                    ...
                    <p>Yes! You can sponsor a cat's care while they wait for adoption. Sponsorships help cover food, medical care, and daily needs. <a href="/contact.php">Contact us</a> to learn more.</p>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-content">
                    ...
                    <p>We always need cat food (wet and dry), litter, toys, bedding, cleaning supplies, and medical supplies. <a href="/contact.php">Contact us</a> for our current wish list and drop-off information.</p>
                </div>
            </div>
...
<section class="section" style="background-color: var(--bg-light);">
    <div class="container text-center">
        ...
        <p class="section-subtitle">We're here to help! Reach out and we'll be happy to answer any questions you have.</p>
