...
$pageTitle = 'Home';
$metaDescription = 'Careful Cat Rescue - Saving lives one paw at a time in Murfreesboro, TN. Adopt, volunteer, or donate to help cats in need.';
...
<section class="hero">
    <div class="container">
        ...
        <p>Welcome to Careful Cat Rescue, where every cat deserves a loving home. We rescue, rehabilitate, and rehome domestic and exotic cats in need throughout Tennessee.</p>
    ...
    <div class="container">
        ...
        <div class="grid grid-3">
            ...
            <div class="card">
                <div class="card-content text-center">
                    <h3>❤️ Rehome</h3>
                    <p>We carefully match cats with loving families to ensure they find their perfect forever homes.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section" style="background-color: var(--bg-light);">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">These wonderful cats are looking for their forever homes. Could one of them be your new best friend?</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-4">
            ...
            <div class="card">
                <div class="card-content text-center">
                    <h3>Donate</h3>
                    <p>Your donation helps us provide food, medical care, and shelter.</p>
                    <a href="/donate.php" class="btn btn-outline mt-2">Donate</a>
                </div>
            </div>
...
<section class="section">
    <div class="container text-center">
        ...
        <div class="hero-actions">
            <?php if ($pageVisibility['adoptions']): ?>
            <a href="/adoptions.php" class="btn btn-primary">Find Your New Friend</a>
            <?php endif; ?>
